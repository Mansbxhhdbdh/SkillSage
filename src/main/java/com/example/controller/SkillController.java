...
//	}
	 ...
	 @GetMapping("/Skilldashboard")
		...
		/*
		 * @GetMapping("/Skills") public String findAllSkills(Model model) {
		 * List<Skills> skills = service.getSkills(); model.addAttribute("skills",
		 * skills); return "skillreport"; }
		 */
    ...
    public String findAllSkills(Model model) {
        ...
        model.addAttribute("skillList", skills); // Here, "skillList" is the attribute name
...
//    }
	...
	public String showAddSkillForm(ch.qos.logback.core.model.Model model) {
	...
	public String findAllSkills(ch.qos.logback.core.model.Model model) {
		// TODO Auto-generated method stub
		return null;
	}
